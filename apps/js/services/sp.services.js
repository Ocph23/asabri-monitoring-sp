angular.module("sp.service", [])
    ...
    {
        var instance=false;
        var datas=[{idSuratBayar:1,idBank:1,masaBerlaku:{dari:new Date(),sampai:new Date()},
            nomorSurat:"125/Vss/VII/2019",kodeBayar:"ED33111THT12252",
        jumlah:25000000, status:"berlaku",
